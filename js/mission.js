...
function renderMissionForm(body) {
  ...
  var diags = ['DPE','DPE Projeté','Amiante','Prélèvement Amiante','Plomb','Prélèvement Plomb','Électricité','Gaz','Termites','ERP','Carrez','Boutin','Avant travaux','Avant démolition','Frais déplacement'];
