...
function renderMissionForm(body) {
  ...
  if (src) {
    ...
    m = {
      ...
      // Prix final en priorité (montant réel facturé), sinon total calculé depuis les tarifs
  ...
  var diags = ['DPE','DPE Projeté','Amiante','Prélèvement Amiante','Plomb','Prélèvement Plomb','Électricité','Gaz','Termites','ERP','Carrez','Boutin','Avant travaux','Avant démolition','Audit énergétique','Frais déplacement'];
  ...
  body.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
      <button onclick="addToGoogleCalendar()" style="padding:12px;border-radius:10px;border:2px solid #0891B2;background:#fff;color:#0891B2;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit">📅 Google Agenda</button>
      <button class="mission-export-btn" onclick="exportMission()">📤 Exporter</button>
    </div>
